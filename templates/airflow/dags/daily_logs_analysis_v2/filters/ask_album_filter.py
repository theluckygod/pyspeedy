...
class AskAlbumFilter(Filter):
    LOGIC_NAME = "ask_album"
    ...
    def build_filting_task(self) -> ProcessLogsTask:
        return (
            ...
            .add_process_logs_command(
                ...
                intent=kiki_logs_constants.INTENT.ASK_SONG_INTENT,
            )
            .add_process_logs_command(
                process_logs_utils.filt_by_slot_name, slot_name="album_name"
            )
        )
