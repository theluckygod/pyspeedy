...
class SearchHighlightFilter(Filter):
    LOGIC_NAME = "search_highlight"
    ...
    def build_filting_task(self) -> ProcessLogsTask:
        return (
            ...
            .add_process_logs_command(
                ...
                intent=kiki_logs_constants.INTENT.ASK_PLAY_MUSIC_INTENTS,
            )
            .add_process_logs_command(
                process_logs_utils.filt_by_logmode,
                log_mode=kiki_logs_constants.LOGMODE.DIFF_HIGHLIGHT,
            )
        )
