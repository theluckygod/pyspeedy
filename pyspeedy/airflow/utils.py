...
def dump_template(
    destination_path: str = "airflow",
    to_overwrite: bool = False,
    test_mode: bool = False,
):
    """Copy the airflow template folder to the specified destination path.

    Args:
        destination_path (str): The path where the tests folder will be copied. Defaults to "airflow".
